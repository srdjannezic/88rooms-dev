...
class SpecialOffersController extends BackEndController {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('SpecialOffer');
    ...
    public function loadModel($id, $ml = false) {
        if ($ml) {
            $model = SpecialOffer::model()->multilang()->findByPk((int) $id);
        } else {
