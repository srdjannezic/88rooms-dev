    ...
    protected function getSortScript() {
        return '
         ...
         $(tbody_selector).bind("sortupdate", function(event, ui) {
            ...
            data["relation_field"] = ' . Cjavascript::encode($this->relation_field) . ';
            data["relation_field_value"] = ' . Cjavascript::encode($this->relation_field_value) . ';
