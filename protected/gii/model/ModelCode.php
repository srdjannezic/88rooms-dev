...
class ModelCode extends CCodeModel {
    ...
    public function attributeLabels() {
        return array_merge(parent::attributeLabels(), array(
                    'tablePrefix' => __('Table Prefix'),
                    'tableName' => __('Table Name'),
                    'modelPath' => __('Model Path'),
                    'modelClass' => __('Model Class'),
                    'baseClass' => __('Base Class'),
                    'buildRelations' => __('Build Relations'),
                ));
    }
    ...
    public function prepare() {
        ...
        foreach ($tables as $table) {
            ...
            //Utility::dump(Yii::getPathOfAlias($this->modelPath).'/'.$className.'.php');
