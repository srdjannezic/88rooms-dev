<article class="single-view special-offer-single">
    ...
    <div class="container_12 pos-rel">
        ...
        <div class="grid_8 last">
            ...
            <p class="active-from"><?php echo sprintf("Active for the period: %s", date('d F', strtotime($data->active_from)) . '-' . date('d F', strtotime($data->active_to))); ?></p>
            <p><?php echo $data->text; ?></p>
            <div class="buttons">
                <a href="<?php echo Utility::createUrl("site/bookNow", array("id" => $data->offer_id)); ?>" class="book-now btn">
