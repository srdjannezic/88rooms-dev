<article class="single-view">
    ...
    <div class="container_12 pos-rel">
        ...
        <div class="grid_8 last">
            ...
            <h2><?php echo CHtml::link(CHtml::encode($data->title), array('news/view', 'slug' => $data->slug),array('title'=> CHtml::encode($data->title))); ?></h2>
            <time><?php echo Utility::dateFormat($data->date_created); ?></time>
            <p class="excerpt"><?php echo $data->_excerpt; ?></p>
            <p class="read-more"><?php echo CHtml::link(Translation::model()->getByKey('read_more'), array('news/view', 'slug' => $data->slug),array('title'=> CHtml::encode($data->title))); ?></p>            
        </div>
