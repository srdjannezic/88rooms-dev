...
function openBooking(f) {
    var forma = document.forms[f];
    $.get(defaultPage,{},function(){
...
// View/cancel
function viewCancelBooking(myLink, f) {
    var forma = document.forms[f];
    
    forma.elements['BookNowForm[view_cancel]'].value = '1';
   
    openBooking(f);
    forma.elements['BookNowForm[view_cancel]'].value = '';
    return false;
}
// Setup
