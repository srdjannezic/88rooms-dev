...
<div id="inner-content" class="bg-white">            
    ...
    <div class="span6-re">
        ...
        <div class="file" id="img_1_box" style="<?php echo (!empty($model->img_1) && !$model->isNewRecord) ? "display:none" : "display:block"; ?>">
            <?php echo $form->fileFieldRow($model, 'img_1'); ?>
        </div>
        <div class="file" id="img_2_box" style="<?php echo (!empty($model->img_2) && !$model->isNewRecord) ? "display:none" : "display:block"; ?>">
            <?php
            echo $form->fileFieldRow($model, 'img_2');
            ?>
        </div>
        <div class="file" id="img_3_box" style="<?php echo (!empty($model->img_3) && !$model->isNewRecord) ? "display:none" : "display:block"; ?>">
            <?php
            echo $form->fileFieldRow($model, 'img_3');
            ?>
        </div>
        <div class="file" id="img_4_box" style="<?php echo (!empty($model->img_4) && !$model->isNewRecord) ? "display:none" : "display:block"; ?>">
            <?php
            echo $form->fileFieldRow($model, 'img_4');
            ?>
        </div>
        <div class="file" id="img_5_box" style="<?php echo (!empty($model->img_5) && !$model->isNewRecord) ? "display:none" : "display:block"; ?>">
            <?php
            echo $form->fileFieldRow($model, 'img_5');
            ?>
        </div>
        <div class="file" id="img_6_box" style="<?php echo (!empty($model->img_6) && !$model->isNewRecord) ? "display:none" : "display:block"; ?>">
            <?php
            echo $form->fileFieldRow($model, 'img_6');
            ?>
        </div>
        <div class="file" id="img_7_box" style="<?php echo (!empty($model->img_7) && !$model->isNewRecord) ? "display:none" : "display:block"; ?>">
            <?php
            echo $form->fileFieldRow($model, 'img_7');
            ?>
        </div>
        <div class="file" id="img_8_box" style="<?php echo (!empty($model->img_8) && !$model->isNewRecord) ? "display:none" : "display:block"; ?>">
            <?php
    ...
    <div class="form-actions">
        ...
        $this->widget('bootstrap.widgets.TbButton', array(
            'buttonType' => 'submit',
            'type' => 'blue',
            'label' => $model->isNewRecord ? __('Kreiraj oglas') : __('Zapamti izmene'),
