<div class="view">
    ...
    <div class="info">
        <h2 class="title-small">            
            <?php echo CHtml::link($data->start->name . " - " . $data->end->name, array('profile/profileAdDetail', "id" => $data->id)); ?>
        ...
        <div class="span-mini-box rightAlign right">
            <div class="btn-group" id="control-btns">
                ...
                if ($data->status != Statuses::COMPLETED && $data->status != Statuses::COMPLETED_JOB) { ?>
